...
public class CounterpartyTest extends EntityGetUpdateDeleteTest {
    ...
    public void createAttributeTest() throws IOException, ApiClientException {
        ...
        AttributeCustomEntity created = (AttributeCustomEntity) api.entity().counterparty().createMetadataAttribute(attribute);
    ...
    public void updateAttributeTest() throws IOException, ApiClientException {
        ...
        AttributeCustomEntity updated = (AttributeCustomEntity) api.entity().counterparty().updateMetadataAttribute(created);
        assertNotNull(created);
