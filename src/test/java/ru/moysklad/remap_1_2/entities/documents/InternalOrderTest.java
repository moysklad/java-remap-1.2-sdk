...
public class InternalOrderTest extends DocumentWithPositionsTestBase {
    ...
    public void createAttributeTest() throws IOException, ApiClientException {
        ...
        Attribute created = api.entity().internalorder().createMetadataAttribute(attribute);
    ...
    public void updateAttributeTest() throws IOException, ApiClientException {
        ...
        Attribute updated = api.entity().internalorder().updateMetadataAttribute(created);
        assertNotNull(created);
