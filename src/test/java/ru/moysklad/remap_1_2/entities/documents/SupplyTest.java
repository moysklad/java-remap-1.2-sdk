...
public class SupplyTest extends DocumentWithPositionsTestBase {
    ...
    public void metadataTest() throws IOException, ApiClientException {
        MetadataAttributeOperationSharedStatesResponse response = api.entity().supply().metadata().get();
    ...
    public void attributesTest() throws IOException, ApiClientException{
        ListEntity<AttributeOperation> attributes = api.entity().supply().metadataAttributes();
    ...
    public void createAttributeTest() throws IOException, ApiClientException {
        ...
        AttributeOperation created =  api.entity().supply().createMetadataAttribute(attribute);
    ...
    public void updateAttributeTest() throws IOException, ApiClientException {
        ...
        AttributeOperation updated =  api.entity().supply().updateMetadataAttribute(created);
        assertNotNull(created);
