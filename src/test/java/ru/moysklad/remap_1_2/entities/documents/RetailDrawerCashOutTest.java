...
public class RetailDrawerCashOutTest extends EntityGetUpdateDeleteTest implements FilesTest<RetailDrawerCashIn> {
    ...
    public void metadataTest() throws IOException, ApiClientException {
        MetadataAttributeOperationSharedStatesResponse response = api.entity().retaildrawercashout().metadata().get();
    ...
    public void attributesTest() throws IOException, ApiClientException{
        ListEntity<AttributeOperation> attributes = api.entity().retaildrawercashout().metadataAttributes();
    ...
    public void createAttributeTest() throws IOException, ApiClientException {
        ...
        AttributeOperation created =  api.entity().retaildrawercashout().createMetadataAttribute(attribute);
    ...
    public void updateAttributeTest() throws IOException, ApiClientException {
        ...
        AttributeOperation updated =  api.entity().retaildrawercashout().updateMetadataAttribute(created);
        assertNotNull(created);
