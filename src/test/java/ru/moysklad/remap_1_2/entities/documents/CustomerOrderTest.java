...
public class CustomerOrderTest extends DocumentWithPositionsTestBase {
    ...
    public void createAttributeTest() throws IOException, ApiClientException {
        ...
        Attribute created = api.entity().customerorder().createMetadataAttribute(attribute);
    ...
    public void updateAttributeTest() throws IOException, ApiClientException {
        ...
        Attribute updated = api.entity().customerorder().updateMetadataAttribute(created);
        assertNotNull(created);
