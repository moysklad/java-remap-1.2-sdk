...
public class PaymentInTest extends EntityGetUpdateDeleteTest implements FilesTest<PaymentIn> {
    ...
    public void metadataTest() throws IOException, ApiClientException {
        MetadataAttributeOperationSharedStatesResponse response = api.entity().paymentin().metadata().get();
    ...
    public void attributesTest() throws IOException, ApiClientException{
        ListEntity<AttributeOperation> attributes = api.entity().paymentin().metadataAttributes();
    ...
    public void createAttributeTest() throws IOException, ApiClientException {
        ...
        AttributeOperation created =  api.entity().paymentin().createMetadataAttribute(attribute);
    ...
    public void updateAttributeTest() throws IOException, ApiClientException {
        ...
        AttributeOperation updated =  api.entity().paymentin().updateMetadataAttribute(created);
        assertNotNull(created);
