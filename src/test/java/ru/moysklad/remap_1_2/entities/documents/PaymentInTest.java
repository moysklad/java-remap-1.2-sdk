...
public class PaymentInTest extends EntityGetUpdateDeleteTest implements FilesTest<PaymentIn> {
    ...
    public void metadataTest() throws IOException, ApiClientException {
        MetadataAttributeSharedStatesResponse<OperationAttribute> response = api.entity().paymentin().metadata().get();
    ...
    public void createAttributeTest() throws IOException, ApiClientException {
        ...
        OperationAttribute created =  api.entity().paymentin().createMetadataAttribute(attribute);
    ...
    public void updateAttributeTest() throws IOException, ApiClientException {
        ...
        OperationAttribute updated =  api.entity().paymentin().updateMetadataAttribute(created);
        assertNotNull(created);
