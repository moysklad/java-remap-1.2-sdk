...
public class ProcessingOrderTest extends EntityGetUpdateDeleteTest implements FilesTest<ProcessingOrder> {
    ...
    public void createAttributeTest() throws IOException, ApiClientException {
        ...
        AttributeOperation created = (AttributeOperation) api.entity().processingorder().createMetadataAttribute(attribute);
    ...
    public void updateAttributeTest() throws IOException, ApiClientException {
        ...
        AttributeOperation updated = (AttributeOperation) api.entity().processingorder().updateMetadataAttribute(created);
        assertNotNull(created);
