...
public class RetailSalesReturnTest extends EntityGetUpdateDeleteTest implements FilesTest<RetailSalesReturn> {
    ...
    public void metadataTest() throws IOException, ApiClientException {
        MetadataAttributeSharedStatesResponse<OperationAttribute> response = api.entity().retailsalesreturn().metadata().get();
    ...
    public void createAttributeTest() throws IOException, ApiClientException {
        ...
        OperationAttribute created =  api.entity().retailsalesreturn().createMetadataAttribute(attribute);
    ...
    public void updateAttributeTest() throws IOException, ApiClientException {
        ...
        OperationAttribute updated =  api.entity().retailsalesreturn().updateMetadataAttribute(created);
        assertNotNull(created);
