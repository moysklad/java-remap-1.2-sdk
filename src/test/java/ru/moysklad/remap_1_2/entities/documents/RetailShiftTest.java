...
public class RetailShiftTest extends EntityTestBase {
    ...
    public void attributesTest() throws IOException, ApiClientException{
        ListEntity<AttributeOperation> attributes = api.entity().retailshift().metadataAttributes();
    ...
    public void createAttributeTest() throws IOException, ApiClientException {
        ...
        AttributeOperation created =  api.entity().retailshift().createMetadataAttribute(attribute);
    ...
    public void updateAttributeTest() throws IOException, ApiClientException {
        ...
        AttributeOperation updated =  api.entity().retailshift().updateMetadataAttribute(created);
        assertNotNull(created);
