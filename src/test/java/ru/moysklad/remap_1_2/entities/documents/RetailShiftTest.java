...
public class RetailShiftTest extends EntityTestBase {
    ...
    public void createAttributeTest() throws IOException, ApiClientException {
        ...
        OperationAttribute created =  api.entity().retailshift().createMetadataAttribute(attribute);
    ...
    public void updateAttributeTest() throws IOException, ApiClientException {
        ...
        OperationAttribute updated =  api.entity().retailshift().updateMetadataAttribute(created);
        assertNotNull(created);
