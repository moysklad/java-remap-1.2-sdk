...
public class PricelistTest extends EntityGetUpdateDeleteTest implements FilesTest<Pricelist> {
    ...
    public void createAttributeTest() throws IOException, ApiClientException {
        ...
        AttributeOperation created = (AttributeOperation) api.entity().pricelist().createMetadataAttribute(attribute);
    ...
    public void updateAttributeTest() throws IOException, ApiClientException {
        ...
        AttributeOperation updated = (AttributeOperation) api.entity().pricelist().updateMetadataAttribute(created);
        assertNotNull(created);
