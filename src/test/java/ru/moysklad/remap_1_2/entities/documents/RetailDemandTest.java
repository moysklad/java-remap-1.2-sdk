...
public class RetailDemandTest extends EntityGetUpdateDeleteTest implements FilesTest<RetailDemand> {
    ...
    public void createAttributeTest() throws IOException, ApiClientException {
        ...
        AttributeOperation created = (AttributeOperation) api.entity().retaildemand().createMetadataAttribute(attribute);
    ...
    public void updateAttributeTest() throws IOException, ApiClientException {
        ...
        AttributeOperation updated = (AttributeOperation) api.entity().retaildemand().updateMetadataAttribute(created);
        assertNotNull(created);
