...
public class RetailDemandTest extends EntityGetUpdateDeleteTest implements FilesTest<RetailDemand> {
    ...
    public void metadataTest() throws IOException, ApiClientException {
        MetadataAttributeSharedStatesResponse<OperationAttribute> response = api.entity().retaildemand().metadata().get();
    ...
    public void createAttributeTest() throws IOException, ApiClientException {
        ...
        OperationAttribute created =  api.entity().retaildemand().createMetadataAttribute(attribute);
    ...
    public void updateAttributeTest() throws IOException, ApiClientException {
        ...
        OperationAttribute updated =  api.entity().retaildemand().updateMetadataAttribute(created);
        assertNotNull(created);
