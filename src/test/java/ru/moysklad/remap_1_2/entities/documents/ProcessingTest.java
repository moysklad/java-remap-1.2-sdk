...
public class ProcessingTest extends EntityGetUpdateDeleteTest implements FilesTest<Processing> {
    ...
    public void createAttributeTest() throws IOException, ApiClientException {
        ...
        AttributeOperation created = (AttributeOperation) api.entity().processing().createMetadataAttribute(attribute);
    ...
    public void updateAttributeTest() throws IOException, ApiClientException {
        ...
        AttributeOperation updated = (AttributeOperation) api.entity().processing().updateMetadataAttribute(created);
        assertNotNull(created);
