...
public class CashInTest extends EntityGetUpdateDeleteTest implements FilesTest<CashIn> {
    ...
    public void createAttributeTest() throws IOException, ApiClientException {
        ...
        AttributeOperation created = (AttributeOperation) api.entity().cashin().createMetadataAttribute(attribute);
    ...
    public void updateAttributeTest() throws IOException, ApiClientException {
        ...
        AttributeOperation updated = (AttributeOperation) api.entity().cashin().updateMetadataAttribute(created);
        assertNotNull(created);
