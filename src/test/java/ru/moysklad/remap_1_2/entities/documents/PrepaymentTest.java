...
public class PrepaymentTest extends EntityTestBase implements FilesTest<Prepayment> {
    ...
    public void createAttributeTest() throws IOException, ApiClientException {
        ...
        OperationAttribute created =  api.entity().prepayment().createMetadataAttribute(attribute);
    ...
    public void updateAttributeTest() throws IOException, ApiClientException {
        ...
        OperationAttribute updated =  api.entity().prepayment().updateMetadataAttribute(created);
        assertNotNull(created);
