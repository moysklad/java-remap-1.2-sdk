...
public class EmployeeTest extends EntityGetUpdateDeleteTest {
    ...
    public void attributesTest() throws IOException, ApiClientException{
        ListEntity<AttributeCustomEntity> attributes = api.entity().employee().metadataAttributes();
    ...
    public void createAttributeTest() throws IOException, ApiClientException {
        ...
        AttributeCustomEntity created = api.entity().employee().createMetadataAttribute(attribute);
    ...
    public void updateAttributeTest() throws IOException, ApiClientException {
        ...
        AttributeCustomEntity updated = api.entity().employee().updateMetadataAttribute(created);
        assertNotNull(created);
