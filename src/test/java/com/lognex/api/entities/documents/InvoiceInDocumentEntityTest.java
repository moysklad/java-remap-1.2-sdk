...
public class InvoiceInDocumentEntityTest extends EntityTestBase {
    ...
    public void getTest() throws IOException, LognexApiException {
        InvoiceInDocumentEntity e = createSimpleInvoiceIn();
    ...
    public void createPositionByIdTest() throws IOException, LognexApiException {
        ...
        ListEntity<DocumentPosition> originalPositions = api.entity().invoicein().getPositions(e.getId());
        ...
        api.entity().invoicein().postPosition(e.getId(), position);
        ListEntity<DocumentPosition> retrievedPositions = api.entity().invoicein().getPositions(e.getId());
    ...
    public void createPositionByEntityTest() throws IOException, LognexApiException {
        ...
        api.entity().invoicein().postPosition(e, position);
        ListEntity<DocumentPosition> retrievedPositions = api.entity().invoicein().getPositions(e);
    ...
    public void createPositionsByIdTest() throws IOException, LognexApiException {
        ...
        api.entity().invoicein().postPositions(e.getId(), positions);
        ListEntity<DocumentPosition> retrievedPositions = api.entity().invoicein().getPositions(e.getId());
    ...
    public void createPositionsByEntityTest() throws IOException, LognexApiException {
        ...
        api.entity().invoicein().postPositions(e, positions);
        ListEntity<DocumentPosition> retrievedPositions = api.entity().invoicein().getPositions(e);
    ...
    public void getPositionTest() throws IOException, LognexApiException {
        ...
        DocumentPosition retrievedPosition = api.entity().invoicein().getPosition(e.getId(), positions.get(0).getId());
        getPositionAsserts(positions.get(0), retrievedPosition);

        retrievedPosition = api.entity().invoicein().getPosition(e, positions.get(0).getId());
        getPositionAsserts(positions.get(0), retrievedPosition);
    }
    ...
    public void putPositionByIdsTest() throws IOException, LognexApiException {
        ...
        DocumentPosition retrievedPosition = api.entity().invoicein().getPosition(e.getId(), p.getId());

        DecimalFormat df = new DecimalFormat("#.###");
        double quantity = Double.valueOf(df.format(p.getQuantity() + randomDouble(1, 1, 3)));
        p.setQuantity(quantity);
        api.entity().invoicein().putPosition(e.getId(), p.getId(), p);
    ...
    public void putPositionByEntityIdTest() throws IOException, LognexApiException {
        ...
        double quantity = Double.valueOf(df.format(p.getQuantity() + randomDouble(1, 1, 3)));
        p.setQuantity(quantity);
        api.entity().invoicein().putPosition(e, p.getId(), p);
    ...
    public void putPositionByEntitiesTest() throws IOException, LognexApiException {
        ...
        double quantity = Double.valueOf(df.format(p.getQuantity() + randomDouble(1, 1, 3)));
        p.setQuantity(quantity);
        api.entity().invoicein().putPosition(e, p, p);
    ...
    public void putPositionBySelfTest() throws IOException, LognexApiException {
        ...
        double quantity = Double.valueOf(df.format(p.getQuantity() + randomDouble(1, 1, 3)));
        p.setQuantity(quantity);
        api.entity().invoicein().putPosition(e, p);
    ...
    public void deletePositionByIdsTest() throws IOException, LognexApiException {
        ...
        ListEntity<DocumentPosition> positionsBefore = api.entity().invoicein().getPositions(e);

        api.entity().invoicein().delete(e.getId(), positions.get(0).getId());

        ListEntity<DocumentPosition> positionsAfter = api.entity().invoicein().getPositions(e);
    ...
    public void deletePositionByEntityIdTest() throws IOException, LognexApiException {
        ...
        api.entity().invoicein().delete(e, positions.get(0).getId());
    ...
    public void deletePositionByEntitiesTest() throws IOException, LognexApiException {
        ...
        api.entity().invoicein().delete(e, positions.get(0));
    ...
    private List<DocumentPosition> createSimplePositions(InvoiceInDocumentEntity e) throws IOException, LognexApiException {
        List<DocumentPosition> positions = new ArrayList<>();
        ...
        return api.entity().invoicein().postPositions(e, positions);
    }
    ...
    private void putPositionAsserts(InvoiceInDocumentEntity e, DocumentPosition p, DocumentPosition retrievedOriginalPosition, Double quantity) throws IOException, LognexApiException {
        DocumentPosition retrievedUpdatedPosition = api.entity().invoicein().getPosition(e, p.getId());
