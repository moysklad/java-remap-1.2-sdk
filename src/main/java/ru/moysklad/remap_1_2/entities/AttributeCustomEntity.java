...
public class AttributeCustomEntity extends MetaEntity implements Attribute {
    ...
    public AttributeCustomEntity(String id) {
        super(id);
    }

    public AttributeCustomEntity(Meta.Type AttributeType, String id, Type type, Object value){
        super(id);
        this.type = type;
        this.value = value;
    ...
    public AttributeCustomEntity(Meta.Type AttributeType, String id, MetaEntity value){
        super(id);
        this.value = value;
