...
public class DocumentMetadataClientEntity<T extends MetaEntity>
    ...
    public DocumentMetadataClientEntity(ApiClient api, String path, Class<T> metaResponseEntityClass) {
