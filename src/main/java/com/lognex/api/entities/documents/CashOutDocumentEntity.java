...
public class CashOutDocumentEntity extends DocumentEntity implements FinanceOutDocumentMarker, IEntityWithAttributes {
    ...
    public CashOutDocumentEntity(String id) {
        super(id);
    }
}
