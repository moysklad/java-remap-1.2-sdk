...
public class PaymentInDocumentEntity extends DocumentEntity implements FinanceInDocumentMarker, IEntityWithAttributes {
    ...
    public PaymentInDocumentEntity(String id) {
        super(id);
    }
}
